...
enum SHA256Hasher {
    static func hash(data: Data) -> [UInt8] {
        ...
        message.append(contentsOf: [
            UInt8((bitLen >> 56) & 0xff),
            UInt8((bitLen >> 48) & 0xff),
            UInt8((bitLen >> 40) & 0xff),
            UInt8((bitLen >> 32) & 0xff),
            UInt8((bitLen >> 24) & 0xff),
            UInt8((bitLen >> 16) & 0xff),
            UInt8((bitLen >> 8) & 0xff),
            UInt8(bitLen & 0xff)
        ])
        ...
        let digest: [UInt32] = [h0, h1, h2, h3, h4, h5, h6, h7]
        return digest.flatMap { w in
            [
                UInt8((w >> 24) & 0xff),
                UInt8((w >> 16) & 0xff),
                UInt8((w >> 8) & 0xff),
